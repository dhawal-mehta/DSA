...
"""
Hint 1
Naive approach of finding all subset complexity will be exponental.
Can sorting work?
"""
"""
Solution Approach
...
def solve(A):
    ...
    for i in range(n):
        max_sum = (max_sum*2 + A[n-i-1] )% 1000000007
        # max_sum %= 1000000007
    
        min_sum = ( min_sum*2 + A[i])% 1000000007
        # min_sum %= 1000000007
    
    return (max_sum - min_sum)% 1000000007
